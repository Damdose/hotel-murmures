    ...
    <section className="flex w-full flex-col items-center gap-14 bg-gradient-to-b from-antique-white to-linen px-5 py-12 md:px-10">
      ...
      >
        {galleryImages.map((img) => (
          <div
            key={img.src}
            className="zoom-host relative w-[85vw] shrink-0 overflow-hidden rounded md:w-[60vw] xl:w-[calc(33.333vw-2rem)]"
          ...
          >
            ...
            />
            {img.showButton && (
              <div className="cta absolute right-4 bottom-4 flex cursor-pointer items-center gap-2 rounded-full bg-white/90 px-5 py-2.5 backdrop-blur-sm hover:bg-white md:right-6 md:bottom-6">

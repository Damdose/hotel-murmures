...
export function LocationCard() {
  return (
    <section className="flex w-full flex-col items-center gap-14 bg-antique-white px-5 py-16 md:px-10 md:py-24">
      <div className="flex w-full max-w-screen-xl flex-col overflow-hidden rounded bg-white md:min-h-[586px] md:flex-row">
        <div className="flex h-full w-full flex-col md:w-[640px] md:max-w-screen-sm md:shrink-0">
          ...
          <div className="flex flex-1 gap-14 px-8 pt-6 pb-12 max-md:flex-col max-md:gap-6 md:px-16 md:pt-14 md:pb-16">
        ...
        <div className="relative h-60 w-full md:h-auto md:min-h-[586px] md:flex-1 md:self-stretch">
          <Image
